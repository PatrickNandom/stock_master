...
const Sidebar = () => {
  ...
  return (
    <aside
      className="max-w-50  hidden bg-[#CDD0DA] sm:block border-r border-gray-300 sticky top-0 sm:h-screen sh-dvh landscape:max-h-[500px]:w-20s pl-[env(safe-area-inset-left)] "
    >
